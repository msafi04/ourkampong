"""
Django settings for oursgkampong_project project.
...
SECRET_KEY = 'q+-6)5=@vfn+#cc)oj6(-k(m6-89fmju5+v$!nv)@(v8ei!t2u'
...
ROOT_URLCONF = 'oursgkampong_project.urls'
...
WSGI_APPLICATION = 'oursgkampong_project.wsgi.application'
